...
function iniciarbanco() {
  ...
  if (NomeUsuario === "") {
    ...
    <div id="MenuDeOpções2">
      ...
      <div id="OpçãoCredito" class="OpçõesMenus">Crédito</div>
...
<h1 id="TituloDoMenuDaOperação">Saque</h1>
...
<span class="EstiloGeral"> <label for="ValorDaOperação">Valor de Saque</label></span>
...
<h1 id="TituloDoMenuDaOperação">Depósito</h1>
<div id="ConfirmaçãoDaOperação">
  <div id="PopUpDaOperação">
      <H3>Deseja confirmar o operação?</h3>
        <p id="ValorValido"></p>
...
<span class="EstiloGeral"> <label for="ValorDaOperação">Valor de Depósito</label></span>
<input type="number" name="ValorDaOperação" id="ValorDaOperação" placeholder="Valor personalizado">
<div id="BtsDeValoresPadrões">
...
<h1 id="TituloDoMenuDaOperação">Transferência</h1>
...
<div id="ArteExtrato"><img src="imgs/ArteExtrato2.png"></div>
